...
import { focusElement, isEmpty } from "utils";
...
const FormBuilder = (formPage) => {
  ...
  let dragRef = useRef(initialDragRef);

  let focusFieldId = useRef(null);
  ...
  const handleDragStart = (droppableId, draggableId) => {
  ...
  const handleDragEnter = (event, droppableId, draggableId) => {
